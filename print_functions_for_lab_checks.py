...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        n_images = len(results_dic) # results_stats_dic['n_dogs_img']
        n_pet_dog = 0 # results_stats_dic['n_match']
        n_class_cdog = 0 # results_stats_dic['n_correct_dogs']
        n_class_cnotd = 0 # results_stats_dic['n_correct_notdogs']
        n_match_breed = 0 # results_stats_dic['n_correct_breed']
